    ...
    public class UsersController : ControllerBase
    {
        ...
        public IActionResult GetUserByUsername(string username)
        {
            try
            {
                ...
                User user = _userService.GetUserByUsername(username); // Ensure your service has this method
            ...
            {
                _logger.LogError($"Error occurred while fetching user with username: {username}", ex);
                return StatusCode(500, "Internal server error");
            }
        }
