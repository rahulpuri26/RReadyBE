    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginModel model)
        {
            ...
            if (user != null && await userManager.CheckPasswordAsync(user, model.Password))
            {
                ...
                // Create a list of claims including the userId
                var authClaims = new List<Claim>
        {
            ...
            new Claim(JwtRegisteredClaimNames.Jti, Guid.NewGuid().ToString())  // Unique JWT ID
                ...
                // Generate JWT token using claims and signing credentials
                ...
                return Ok(new
                {
                    ...
                    expiration = token.ValidTo  // Return the token expiration date
                });
            }
